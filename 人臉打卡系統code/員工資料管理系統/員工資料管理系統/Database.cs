...
namespace 人臉辨識打卡系統
{
    class Database
    {
        ...
        public void update(int id, string name, string position, string department, string uid)
        {
            exec(String.Format("UPDATE dbo.員工 SET 姓名='{0}', 職位='{1}', 部門='{2}', UID='{3}' WHERE ID={4}", name, position, department, uid, id));
        }
